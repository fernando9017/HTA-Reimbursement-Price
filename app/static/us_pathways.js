...
const PATHWAY_PROGRAMS = [
    // ── Payer-Driven Pathways ──────────────────────────────────────────
    {
        ...
        nsclcCoverage: true,
        description: "Evidence-based regimens selected through rigorous evaluation by UHC's Oncology Advisory Committee (practicing oncologists from academic and community settings). Prior authorization for chemotherapy requires submission through their CGP tool. Pathways cover specific cancer types and states.",
        keyFeatures: [
            "Oncology Advisory Committee reviews pathways with disease-specific expert consultants",
            "Prior authorization required for off-pathway regimens",
            "Covers UHC Commercial, Medicare Advantage, and Medicaid managed care",
            "Pathway adherence influences reimbursement rates",
        ],
        url: "https://www.uhcprovider.com/en/resource-library/cancer-therapy-pathways-program.html",
        dataAvailability: "Pathway regimen lists available to contracted providers via CGP portal; not publicly downloadable",
        lastChecked: "2026-03",
    },
    {
        id: "anthem",
        ...
        nsclcCoverage: true,
        description: "Anthem released pathway programs targeting breast, colon, and lung cancer as initial priorities. Reported adherence rates: 63% breast, 72% colon, 63% NSCLC. The program is administered in collaboration with pathway vendors.",
        keyFeatures: [
            "NSCLC is one of three initial priority tumour types",
            "63% pathway adherence reported for NSCLC",
            "Targets regimen standardisation and cost reduction",
            "Uses peer-to-peer counseling for off-pathway justifications",
        ],
    ...
    },
    {
        ...
        nsclcCoverage: true,
        description: "A collaboration between NCCN, McKesson, and The US Oncology Network. Value Pathways are a refinement of NCCN Guidelines that highlight evidence-based treatment options based on efficacy, toxicity, and financial impact. Up to 90% of US Oncology Network medical oncologists follow these pathways.",
        keyFeatures: [
