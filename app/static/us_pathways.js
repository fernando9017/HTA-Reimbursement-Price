...
const PATHWAY_PROGRAMS = [
    ...
    },
    {
        ...
        nsclcCoverage: true,
        description: "Humana publishes a Part B Step Therapy Preferred Drug List with explicit NSCLC drug class preferences. Cemiplimab (Libtayo) is the sole preferred PD-1/PD-L1 agent for NSCLC; pembrolizumab, nivolumab, atezolizumab, and durvalumab are nonpreferred. OncoHealth (Oncology Analytics) manages medical oncology PA. Evolent Health provides additional pathway infrastructure.",
        keyFeatures: [
            "Part B Step Therapy: cemiplimab PREFERRED over pembrolizumab/nivolumab for NSCLC (publicly documented)",
            "OncoHealth manages oncology PA for Humana/CarePlus/GEHA",
            "Evolent Health provides pathway infrastructure",
            "Peer-to-peer counseling model for off-pathway treatment",
            "28 patient advocacy orgs raised concerns about NSCLC coverage restrictions (Jan 2025)",
        ],
        url: "https://provider.humana.com/coverage-claims/prior-authorizations/prior-authorization-lists",
        pdfUrls: [
            { label: "2025 Part B Step Therapy Preferred Drug List", url: "https://assets.humana.com/is/content/humana/2025%20Part%20B%20step%20therapy%20preferred%20drug%20listpdf/" },
        ],
        dataAvailability: "Part B Step Therapy list publicly accessible (PDF); OncoHealth clinical criteria available upon request; Evolent ODL also applicable",
        lastChecked: "2026-03",
    },
    {
        id: "bcbs-michigan",
...

    {
        ...
        nsclcCoverage: true,
        description: "Cigna publishes a 49-page oral oncology drug policy (Policy 1403) with NSCLC-specific step therapy: alectinib preferred for ALK+ NSCLC. The Cigna Oncology Medications Policy (managed by eviCore) and MedOnc Master Drug List are posted as public PDFs. 51 value-based pathways cover lung cancer; on-pathway regimens receive immediate PA approval.",
        keyFeatures: [
            "Cigna Policy 1403: alectinib preferred 1L ALK+ NSCLC; step therapy for brigatinib/ceritinib",
            "Cigna Oncology Medications Policy (public PDF) governs IV chemo/immunotherapy",
            "51 value-based pathways; on-pathway = immediate PA approval",
            "Advisory panel of board-certified oncologists from Cigna, eviCore, and community practices",
            "35% lower costs for on-pathway vs off-pathway NSCLC patients (published data)",
        ],
        url: "https://www.evicore.com/insights/pathways-program",
        pdfUrls: [
            { label: "Cigna Policy 1403: Oncology Medications (49 pages)", url: "https://static.cigna.com/assets/chcp/pdf/coveragePolicies/pharmacy/ph_1403_coveragepositioncriteria_oncology.pdf" },
            { label: "Cigna Oncology Medications Policy V1.0.2025", url: "https://www.evicore.com/sites/default/files/clinical-guidelines/2025-05/Cigna%20Oncology%20Medications%20Policy_V1.0.2025_Eff02.19.2025_pub01.15.2025_upd05.23.2025.pdf" },
        ],
        dataAvailability: "Cigna Policy 1403 and Oncology Medications Policy publicly accessible as PDFs; on-pathway regimen lists visible during PA process only",
        lastChecked: "2026-03",
    },
    {
        id: "evolent",
...

    {
        ...
        nsclcCoverage: true,
        description: "Aetna publishes detailed Clinical Policy Bulletins (CPBs) for individual oncology drugs with specific NSCLC coverage criteria — the most granular publicly accessible US payer coverage data. 12+ NSCLC-relevant CPBs specify exact indications, biomarker requirements, line of therapy, and combination partners. AIM Specialty Health partnership for PA management.",
        keyFeatures: [
            "12+ publicly accessible CPBs with NSCLC-specific drug coverage criteria",
            "CPBs specify biomarker requirements, line of therapy, combination partners",
            "Medicare Part B step therapy: cemiplimab preferred over pembrolizumab for NSCLC",
            "AIM Specialty Health partnership for oncology PA management",
            "~23M medical members across commercial, Medicare Advantage, and Medicaid",
        ],
        url: "https://www.aetna.com/cpb/medical/data/cpb_alpha.html",
        pdfUrls: [
            { label: "CPB #0890: Pembrolizumab (Keytruda)", url: "https://www.aetna.com/cpb/medical/data/800_899/0890.html" },
            { label: "CPB #0995: Amivantamab (Rybrevant)", url: "https://www.aetna.com/cpb/medical/data/900_999/0995.html" },
            { label: "CPB #0892: Nivolumab (Opdivo)", url: "https://www.aetna.com/cpb/medical/data/800_899/0892.html" },
            { label: "CPB #0909: Atezolizumab (Tecentriq)", url: "https://www.aetna.com/cpb/medical/data/900_999/0909.html" },
        ],
        dataAvailability: "CPBs publicly accessible — most granular US payer NSCLC coverage data available. AIM pathway content proprietary.",
        lastChecked: "2026-03",
    },
...
const DATA_METHODOLOGY = {
    ...
    humana: {
        confidence: "high",
        urlQuality: "Direct PDF link to Humana 2025 Part B Step Therapy Preferred Drug List with NSCLC-specific PD-1/PD-L1 class preferences",
        primarySources: [
            "Humana 2025 Part B Step Therapy Preferred Drug List (PDF): cemiplimab sole PREFERRED agent in PD-1/PD-L1 NSCLC class; pembrolizumab, nivolumab, atezolizumab, durvalumab all NONPREFERRED (assets.humana.com)",
            "OncoHealth medical policies for Humana: manages oncology PA for Humana/CarePlus/GEHA (oncohealth.us/medicalpolicies/humana/)",
            "Evolent ODL January 2026 (via NHPRI): additional drug tier data applicable to Humana plans",
        ],
        secondarySources: [
            "NCCS/28 patient advocacy organizations letter to Humana (Jan 2025) — raised concerns that NSCLC coverage policy is 'significantly more restrictive than NCCN guidelines' (canceradvocacy.org)",
            "Humana Part B Step Therapy 30-Day Change Notification PDF",
        ],
        methodology: "Therapy positions extracted directly from Humana's publicly posted Part B Step Therapy Preferred Drug List. The PD-1/PD-L1 NSCLC drug class has cemiplimab as the sole preferred agent with all others requiring step therapy. This aligns with Evolent ODL data (also cemiplimab preferred). OncoHealth manages detailed medical oncology PA with clinical criteria available upon request.",
        limitations: "Part B Step Therapy list covers Medicare Advantage plans only; commercial plan coverage may differ. OncoHealth clinical criteria not fully posted online (available by calling 888-916-2616). The cemiplimab preference over pembrolizumab diverges from NCCN and was criticised by 28 patient advocacy organisations.",
        dataInComparison: "PD-1/PD-L1 positions extracted from publicly accessible Humana step therapy list. High confidence for the checkpoint inhibitor class. Other drug classes rely on Evolent ODL and OncoHealth criteria.",
    },
    "bcbs-michigan": {
        confidence: "low",
    ...
    evicore: {
        confidence: "high",
        urlQuality: "Cigna Policy 1403 (49-page PDF) and Cigna Oncology Medications Policy (public PDF) contain NSCLC-specific drug coverage criteria",
        primarySources: [
            "Cigna Drug & Biologic Coverage Policy 1403 (49 pages, public PDF): alectinib preferred for 1L ALK+ NSCLC; step therapy for brigatinib, ceritinib; KRAS G12C criteria for adagrasib (static.cigna.com/.../ph_1403_coveragepositioncriteria_oncology.pdf)",
            "Cigna Oncology Medications Policy V1.0.2025 (public PDF, managed by eviCore): governs IV chemo/immunotherapy for Cigna members (evicore.com/.../Cigna_Oncology_Medications_Policy_V1.0.2025.pdf)",
            "eviCore Oncology Value-Based Pathways programme page (evicore.com/insights/pathways-program): 51 pathways including lung; on-pathway = immediate PA",
        ],
        secondarySources: [
            "Journal of Clinical Pathways (Jul/Aug 2023): eviCore pathways methodology paper by Stephen Hamilton MD",
            "Published outcomes: 35% lower costs for on-pathway vs off-pathway NSCLC patients ($18,042 vs $27,737)",
            "eviCore Radiation Oncology Guidelines with dedicated NSCLC section (public PDF)",
            "Cigna Newsroom: 'Helping Oncologists Identify Best Cancer Care' — 5.2% adherence increase, $24M savings",
        ],
        methodology: "Drug-level preferences extracted from Cigna Policy 1403 (oral oncology) and Cigna Oncology Medications Policy (IV drugs). Policy 1403 explicitly designates alectinib as preferred first-line ALK inhibitor with step therapy for alternatives. The 51 value-based pathways programme selects on-pathway regimens from NCCN based on ASCO/NCCN/ESMO value frameworks, reviewed by advisory panel of board-certified oncologists.",
        limitations: "On-pathway vs off-pathway regimen lists for the full 51 pathways are only visible during the PA portal process. Policy 1403 covers oral drugs; IV drug specifics are in the Oncology Medications Policy PDF which is large and not fully extractable. Cigna plan-specific criteria may differ from eviCore core guidelines used by external payer clients.",
        dataInComparison: "ALK+ positions extracted from Policy 1403 (high confidence). Other positions based on programme's documented NCCN alignment and published outcome data. Overall high confidence for major drug classes.",
    },
    evolent: {
        confidence: "high",
...
const INSTITUTION_VERIFICATION = {
    ...
    evicore:     { level: "verified",  source: "Cigna Policy 1403 (49-page PDF): alectinib preferred 1L ALK+ NSCLC; Cigna Oncology Medications Policy V1.0.2025 (public PDF); eviCore radiation/imaging guidelines with NSCLC sections" },
    ...
    humana:      { level: "verified",  source: "Humana 2025 Part B Step Therapy Preferred Drug List (public PDF): cemiplimab preferred over pembrolizumab/nivolumab for NSCLC PD-1/PD-L1 class; OncoHealth medical policies" },
